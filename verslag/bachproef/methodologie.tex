...
% TODO deel van samenvatting van wetenschappelijk artikel
% De tools ondergaan een evaluatie om hun vermogen om een wetenschappelijk artikel in PDF-formaat te vereenvoudigen, indien dat mogelijk is. Als dit niet mogelijk is, gebeurt het kopiëren en plakken van de tekst in de toepassing. Vervolgens vindt een evaluatie van de eventuele beperkingen of tekortkomingen plaats. 
...
% API-calls naar de HuggingFace server gebeurt met de requests-library, terwijl deze requests voor GPT-3 perfect binnen eenzelfde library kan gebeuren. 
