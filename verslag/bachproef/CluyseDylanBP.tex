...
\lstdefinelanguage{Python}{
	keywords=[1]{def, return, for, in, class, from, import},
	keywordstyle=[1]\color{Bittersweet},
	keywords=[2]{conn, cursor, rows, session, engine, metadata, Base, session, connect, create\_engine, Table, desc, func, sessionmaker, declarative, query},
	keywordstyle=[2]\color{purple},	
	keywords=[3]{cursor(), fetchall, close, execute}, 
	keywordstyle=[3]\color{violet},
	keywords=[4]{pyodbc, sqlalchemy},
	keywordstyle=[4]\color{RoyalBlue},
	keywords=[5]{select, with\_only\_columns, where, order\_by, limit},
	keywordstyle=[5]\color{Aquamarine},
	keywords=[6]{},
...
\title[De opbouw van een prototype en een vergelijkende studie.]%
    {Scholieren met dyslexie van de derde graad middelbaar onderwijs ondersteunen bij het lezen van wetenschappelijke papers via tekstvereenvoudiging}
