...
Volgens \textcite{Hollenkamp2020} moet de samenvatting van een wetenschappelijk artikel altijd de volgende drie zaken bevatten:
\begin{itemize}
...
\textcite{Case2008} haalt aan om homoniemen en homofonen te vervangen. 
...
Om een abstractieve samenvatting met deep learning op te bouwen bestaan er verschillende modellen. Het Pegasus-model beschreven in \textcite{Zhang2020} handelt \textit{gap-sentences} af met pre-trained models voor samenvatting met NLP. Pegasus haalt kernzinnen uit een invoertekst en zal die zinnen vervolgens als één uitvoerzin uitschrijven. Dit model werd getrained en beoordeeld op samenvattingstaken zoals emails, patenten, rekeningen en ook wetenschappelijke artikelen \autocite{Zhang2020}.

\subsubsection{Programmeren}

 Hieronder een code-snippet van hoe een simpele abstraherende samenvatting kan worden gemaakt met Google Pegasus.
