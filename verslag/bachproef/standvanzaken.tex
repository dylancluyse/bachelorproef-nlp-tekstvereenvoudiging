...
Oogbewegingsexperimenten van \textcite{RiveroContreras2021, Zhang2021} laten zien dat geoefende lezers bij 50-80\% van de woorden pauzeren om zich erop te fixeren. Mensen met dyslexie kunnen de letters correct herkennen, maar kunnen last hebben van verspringende letters tussen woorden in zinnen. Opsommingen kunnen het lezen aangenamer maken dan enkel volzinnen in doorlopende tekst.
...
\begin{figure}[H]
	...
	\end{center}
	\caption{Afbeelding uit \textcite{Bezem2016}.}
\end{figure}
...
Het experiment van \textcite{Rello2013a} wijst uit dat frequente woordenschat een significant verminderend effect heeft op de decodeertijd of ontcijfertijd bij mensen met dyslexie significant vermindert wanneer de tekst een frequent woordgebruik toepast. De decodeertijden bij deelnemers met dyslexie waren significant korter bij het gebruik van frequente woordenschat, terwijl de decodeertijd bij minder frequente woordenschat hoger lag. Het verschil bij deelnemers zonder dyslexie was amper merkbaar.
...
Tijdens het leren schrijven worden letters regelmatig in spiegelbeeld geschreven. Een d/b of een p/d worden door elkaar gehaald \autocite{Bonte2020, Romanovska2021} en kan zo een nadelig effect hebben op de leestijd van een scholier met dyslexie. Onderzoeken wijzen uit hoe ontwikkelaars rekening kunnen houden met de visuele weergave van een applicatie. De leessnelheid en decodeertijd van scholieren met dyslexie vergroot wanneer het lettertype groter is dan 14pt bij digitale en uitgeprinte documenten. De decodeertijd bij 18 tot 26pt was significant sneller dan teksten met 14pt bij bevraagden met en zonder dyslexie. Daarnaast wordt een \textit{sans-serif}, \textit{monospaced} of \textit{roman} lettertype zoals Arial, Helvetica of Verdana aangeraden. Lettertypes zoals OpenDys die ontworpen zijn voor scholieren met dyslexie hebben een neutraal effect op lezers met of zonder dyslexie. Cursieve lettertypes hebben een nadelig effect op het leestempo van zowel gewone scholieren als scholieren met dyslexie en wordt afgeraden \autocite{Rello2013b, Rello2015}.
...
\begin{figure}[H]
	...
	\caption{Afbeelding uit \textcite{Rello2013b}. De voorkeur van de bevraagden omtrent lettertype. }
\end{figure}
...
De achtergrondkleur aanpassen naar zachtgeel, -groen of lichtblauw heeft een verbeterend effect op scholieren met dyslexie in het lager en middelbaar onderwijs en zijn noodzakelijk voor een aangename leeservaring \autocite{Bezem2016, Rello2017}. De eindgebruiker moet in staat zijn om zelf een kleurschema te kiezen. Een minimalistisch ontwerp met pictogrammen en statische inhoud kan mensen met dyslexie helpen belangrijke informatie te concentreren volgens \textcite{Anthony2020}. Visualisaties zoals afbeeldingen en schema's hebben ook een significant effect op de leesbaarheid van een tekst, wat blijkt uit het onderzoek van \textcite{Rello2012b}, hoewel de impact op de begrijpelijkheid van de tekst weinig tot niet verandert.
