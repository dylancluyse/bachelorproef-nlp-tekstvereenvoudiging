...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=10cm]{img/prompt-engineering-medium.png}
	\end{center}
...
\begin{center}
	\begin{tabular}{ m{4cm} | m{10cm} | }
		...
		\hline
		\caption{Samenvattend schema met vaak voorkomende struikelblokken bij NLP-applicaties.}
