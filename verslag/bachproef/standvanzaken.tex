...
Voor sommige lezers kan het intensief lezen van een complexe tekst echter een uitdaging zijn, zoals scholieren met dyslexie. Om deze groep te helpen, wordt vaak \textit{manual text simplification} toegepast. \textit{Manual text simplification} of MTS kan worden bereikt door het gebruik van eenvoudige woordenschat, zinsstructuren en formaatwijzigingen.
...
\begin{center}[H]
		\begin{table}
			...
			\hline
			Formaat- aanpassingen & Marges aanpassen \\
...
In tabel \ref{table:benefits-mts} worden de bewezen technologieën opgesomd met hun samenhangend voordeel.
