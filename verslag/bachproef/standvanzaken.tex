...
% todo https://writingcenter.uconn.edu/wp-content/uploads/sites/593/2014/06/How_to_Summarize_a_Research_Article1.pdf
...
% https://www.vlaanderen.be/taaladvies/taaladviezen/teksten-schrijven/formulering/zinsbouw-moeilijke-constructies % https://www.vlaanderen.be/taaladvies/taaladviezen/teksten-schrijven/formulering/afkortingen-gebruik
...
% \textcite{Kandula2010} haalt twee manieren aan om lexicale vereenvoudiging mogelijk te maken, namelijk het vervangen door een synoniem en het aanmaken of genereren van extra uitleg. Zij bouwden verder op een vorig onderzoek van .
...
\begin{figure}[H]
	...
	\caption{Afbeelding van \textcite{Simon2021}. De evolutie van pre-trained taalmodellen wordt hier weergegeven tot eind 2022. De grootte van deze modellen verandert continu. }
\end{figure}

Uit General Language Understanding Evaluation (GLUE) benchmarks van (..) werden GPT-3 en verwante BERT-modellen tegen elkaar gestaafd. 

% https://symbl.ai/blog/gpt-3-versus-bert-a-high-level-comparison/

\textcite{Li2022} benadrukt dat GPT-3 voor simpele taken \textit{overkill} is. Taken buiten het genereren van teksten, zoals sentimentanalyse en -classificatie, worden beter met een kleiner taalmodel zoals BERT en aanverwante BERT-zijtakmodellen uitgevoerd. Dit heeft ook een invloed op budget, want GPT-3 is een API waar per token wordt betaald, terwijl BERT gratis en open-source is. \textcite{Strubell2019, Simon2021} haalt de ecologische effecten aan van ontwikkelaars die te snel voor deze modellen grijpen. Er is een bewezen effect van efficiëntie kleinere modellen, gebruik van Cloud-infrastructuur en ten slotte een geschikte model finetuning.
